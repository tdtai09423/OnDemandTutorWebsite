...
//#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Account__3214EC071FEBF759");
        ...
        {
            entity.HasKey(e => e.CurriculumId).HasName("PK__Curricul__06C9FA1C6E27076B");
            ...
            entity.HasOne(d => d.Tutor).WithMany(p => p.Curricula)
                ...
                .HasConstraintName("FK__Curriculu__Tutor__5165187F");
        });
        ...
        modelBuilder.Entity<Learner>(entity =>
        {
            ...
            entity.HasIndex(e => e.LearnerId, "UQ__Learner__67ABFCDB3964DC28").IsUnique();
            ...
            entity.HasOne(d => d.Membership).WithMany(p => p.Learners)
                ...
                .HasConstraintName("FK__Learner__Members__49C3F6B7");
        });

        modelBuilder.Entity<LearnerOrder>(entity =>
        {
            entity.HasKey(e => e.OrderId).HasName("PK__LearnerO__C3905BCFC45F38A1");
            ...
            entity.HasOne(d => d.Curriculum).WithMany(p => p.LearnerOrders)
                ...
                .HasConstraintName("FK__LearnerOr__Curri__571DF1D5");
        ...
        modelBuilder.Entity<Major>(entity =>
        {
            ...
            entity.HasIndex(e => e.MajorName, "UQ__Major__5FF4A37B7D8D5156").IsUnique();
        ...
        {
            entity.HasKey(e => e.MembershipId).HasName("PK__Membersh__92A786797B5C2F4D");

            entity.ToTable("Membership");

            entity.HasIndex(e => e.MembershipDescription, "UQ__Membersh__28D65D2368AE6E30").IsUnique();

            entity.HasIndex(e => e.MembershipLevel, "UQ__Membersh__D059A621B9F8B616").IsUnique();
        ...
        modelBuilder.Entity<ReviewRating>(entity =>
        {
            ...
            entity.HasOne(d => d.Learner).WithMany()
                .HasForeignKey(d => d.LearnerId)
                .HasConstraintName("FK__ReviewRat__Learn__4E88ABD4");

            entity.HasOne(d => d.Tutor).WithMany()
                .HasForeignKey(d => d.TutorId)
                .HasConstraintName("FK__ReviewRat__Tutor__4D94879B");
        });

        modelBuilder.Entity<Section>(entity =>
        {
            entity.HasKey(e => e.SectionId).HasName("PK__Section__80EF08723598794C");
        ...
        modelBuilder.Entity<Tutor>(entity =>
        {
            ...
            entity.HasIndex(e => e.TutorId, "UQ__Tutor__77C70FE3F5ACC585").IsUnique();
