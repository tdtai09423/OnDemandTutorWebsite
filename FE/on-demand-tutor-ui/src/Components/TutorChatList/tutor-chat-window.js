...
function TutorChatWindow({ chatBoxId, userRole, onClose, me, they }) {
  ...
  useEffect(() => {
    const newConnection = new signalR.HubConnectionBuilder()
      .withUrl(
        `${process.env.REACT_APP_SIGNALR_URL || "https://localhost:7010"}/chatHub?chatBoxId=${chatBoxId}`,
                ...
                if (m.sender !== userRole) {
                  return (
                    <div
                      key={index}
                      className={
                        m.sender !== userRole ? "my-message" : "other-message"
                      }
                    >
                      <div className="d-flex justify-content-between">
                        <p className="small mb-1">
                          {they.learnerNavigation.firstName}
                        </p>
                  ...
                  return (
                    ...
                    >
                      <div className="d-flex justify-content-between">
                        ...
                        <p className="small mb-1">
                          {me.tutorNavigation.firstName}
                        </p>
                      </div>
                      <div className="d-flex flex-row justify-content-end mb-4 pt-1">
                        <div>
                          <p
                            className="small p-2 me-3 mb-3 text-black rounded-3"
