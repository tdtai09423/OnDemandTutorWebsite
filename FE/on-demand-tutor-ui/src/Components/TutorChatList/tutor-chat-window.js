...
function TutorChatWindow({ chatBoxId, userRole, onClose, me, they }) {
                                    ...
                                    return (
                                        <div key={index} className={(m.sender !== userRole) ? 'my-message' : 'other-message'}>
                                            <div className="d-flex justify-content-between">
                                                <p className="small mb-1">{they.learnerNavigation.firstName}</p>
                                                <p className="small mb-1 text-muted">{m.SendDate}</p>
                                            </div>
                                            <div className="d-flex flex-row justify-content-start">
                                                <img
                                                    src={(they.learnerPicture) ? they.learnerPicture : "https://villagesonmacarthur.com/wp-content/uploads/2020/12/Blank-Avatar.png"}
                                                    alt="avatar 1"
                                    ...
                                    return (
                                        <div key={index} className={(m.sender === userRole) ? 'my-message' : 'other-message'}>
                                            <div className="d-flex justify-content-between">
                                                ...
                                                <p className="small mb-1">{me.tutorNavigation.firstName}</p>
                                            </div>
                                            <div className="d-flex flex-row justify-content-end mb-4 pt-1">
                                                ...
                                                <img
                                                    src={(me.tutorPicture) ? me.tutorPicture : "https://villagesonmacarthur.com/wp-content/uploads/2020/12/Blank-Avatar.png"}
                                                    alt="avatar 1"
                                                    style={{ width: "45px", height: "100%" }}
                                                />
                                            </div>
