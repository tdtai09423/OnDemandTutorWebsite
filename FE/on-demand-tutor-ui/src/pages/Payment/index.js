  ...
  const handleCheckout = async () => {
    ...
    try {
      const response = await axios.post(
        `${process.env.REACT_APP_API_BASE_URL || "https://localhost:7010/api"}/LearnerOrder/short-term-booking`,
        data,
        {
          headers: {
      ...
      const checkout = await axios.post(
        `${process.env.REACT_APP_API_BASE_URL || "https://localhost:7010/api"}/LearnerOrder/checking-out`,
        formData,
        {
          headers: {
          ...
          <Card>
            ...
            <Card.Body>
              ...
              <p className="mt-1 text-muted">
                It's safe to pay on Preply. All transactions are protected by
                SSL encryption.
              </p>
            </Card.Body>
          </Card>
